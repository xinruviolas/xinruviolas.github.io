        ...
        <Navbar className={"navbar"} bg="light" expand="lg" fixed="top">
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                ...
                <Nav className="ml-auto" variant = "custom" activeKey={location.pathname}>
                    <Nav.Item>
                        <Link to={process.env.PUBLIC_URL+"/"} class={"navlink"} id = "text" activeStyle={{color:"red"}}>Projects</Link>
                        {/*<Nav.Link href="/" id = "text" class={"pagelink"}>Projects</Nav.Link>*/}
                    </Nav.Item>
                    <Nav.Item>
                        <Link to={process.env.PUBLIC_URL+"/about"} class={"navlink"} id = "text">About</Link>
                        {/*<Nav.Link href={process.env.PUBLIC_URL+"/about"} id = "text">About</Nav.Link>*/}
                    </Nav.Item>
                    <Nav.Item>
                        <Link to={resume} id = "text" target="_blank">Resume</Link>
                    </Nav.Item>
                </Nav>
            </Navbar.Collapse>
        </Navbar>
